...
public class DiaryHandler {
	public boolean writePatientDiary(DataSource datasource, String userID,String date,String image,String patientDescription ) {
		Connection con = null;
		try {
			...
			//新增資料
			 if(res.next()==false) {
				result="insert into patientdiary(date,patientID,patientDescription,photo)values('"+date+"','"+userID+"','"+patientDescription+"','"+image+"')";
	...
	public boolean writeFamilyDescription(DataSource datasource, String userID,String familyID,String date,String familyDescription ) {
		Connection con = null;
		try {
	...
	public boolean writeFamilyDiary(DataSource datasource, String userID,String date,String image,String description ) {
		...
		try {
			...
			//新增資料
			 if(res.next()==false) {
				result="insert into familydiary(date,familyID,description,photo)values('"+date+"','"+userID+"','"+description+"','"+image+"')";
				st.executeUpdate(result);
			 }
			 //修改已有的資料
			 else {
