...
/**
 * Servlet implementation class ReportArtilceServlet
 */
...
public class ReportArticleServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(userID!=null) {
			...
			response.getWriter().println(report.ReportArticle(datasource, articleID, author, title, userID, reason, description));
		}
	}
